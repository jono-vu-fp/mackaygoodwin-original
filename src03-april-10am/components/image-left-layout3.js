  ...
  <div className={'vcfo_section '+props.addClass}>
    <div className="container">
      ...
      <div class="vcfo_right">
        ...
        {props.btn1Link !== null && props.btn1Link !== "" ? <Link className="btn btn-primary me-5" to={props.btn1Link}>{props.btn1Txt}</Link> : ""}
            {typeof props.btnClick !== "undefined" && props.btnClick !== null && props.btnClick !== "" ? <button className="btn btn-primary me-5" onClick={props.btnClick}>{props.btn1Txt}</button> : ""}
