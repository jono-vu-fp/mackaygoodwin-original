...
const NewsList = (props) => (
  <section className="news-list">
    <div className="container">
      <div className="row">
        <h3 className="my-5 con_title">{props.title}</h3>
      </div>
      <div className="row">
        {props.data.map((d, index) => { return <div className="col-lg-4 col-md-12  mt-4">
          <div className="listbg">
            ...
            <Link className="ps-4 pe-4 px-4"  to={d.conLink2} target="_blank">Show on google maps <i className="fa fa-chevron-right" aria-hidden="true"></i></Link>
          </div>
        </div> })}
      </div>
    </div>
