...
const CompanyLiquidationMelbourne = ({ data }) => {
  ...
  const breadCrumbs = [
    { link: "/", title: "Home" }, 
    { title: "Company Liquidation Melbourne" },
  ];
  ...
  return (
    <div className="restructure_land service liquidation clm-page cloc_s_page bannertitle_big">
      ...
      <div className="wcmg_section margin_bottom">
        ...
        <div className="wva_section fd_section dca_section dpn_part margin_bottom cl_section">
        <div className="container">
          ...
          <div className="wva_right">
           ...
           <div dangerouslySetInnerHTML={{ __html: data.wpPage.whatIsLiquidation.whatDesc }}></div> 
                 ...
                 <button className="btn btn btn-primary" onClick={()=>showContactForm()}>Find out more</button>

          </div>
        </div>
      </div>

        {/*<div class="clm-sec-4 order_reverce">
       <div className="wbl_section">
              <div className="container">
                <div className="wbl_left">
                   <a href="javascript:void(0);" onClick={()=>setShowVid1(true)}><img src={data.wpPage.whatIsLiquidation.whatThumbnail?.localFile?.childImageSharp?.resize?.src} /></a>
