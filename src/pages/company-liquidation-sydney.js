...
const CompanyLiquidationSydney = ({ data }) => {
  ...
  return (
    <div className="restructure_land service liquidation clm-page cloc_s_page">
      <Layout>
      ...
      <div className="wcmg_section">
        ...
        <div class="clm-sec-4 wil_sec">
       <div className="wbl_section">
              <div className="container">
                <div className="wbl_left">
                   <a href="javascript:void(0);" onClick={()=>setShowVid1(true)}><img src={data.wpPage.whatIsLiquidation.whatThumbnail?.localFile?.childImageSharp?.resize?.src} /></a>
      ...
      <section class="spek_sec spek_sec_left">
          <div class="container container2">
            <div class="spek_head">
              <h2>
                {data.wpPage.professionalSection.profeheading}
              </h2>
              <div
                class="p"
                dangerouslySetInnerHTML={{
                  ...
                  return (
                    <div class="spek_grid">
                      <div class="spek_item">
                        ...
                        /> 
                        <Link className="btn" to={d.linkText.link}>{d.linkText.title}</Link>
   ...
   <section class="wva_section about_section history_section identifix_sec2 mg_acnew4 ond_sec dpn-sec1 lrb_sec1 ">
      ...
      <section class="spek_sec">
       <div class="container container2">
         <div class="spek_head">
          <h2>
                {data.wpPage.theyMayIncludeSection.theyheading}
              </h2>
              <div
                class="p"
                dangerouslySetInnerHTML={{
             ...
             <div class="step_item">
               ...
               <div class="step_gcont">
                <h3>{d.theytitle}</h3>
                         ...
                         <Link className="btn btn-primary" to={d.theylink.link}>{d.theylink.title}</Link>
                </div>
             </div>
           </div>
          })}
              ...
              {data.wpPage.theyMayIncludeSection.includes.map((d, key) => {
                return <div id="mediamoments" class="wva_section fd_section dca_section mg_acnew1">
                 <div class="container">
                   <div class="row">
                     <div class="wva_left  col-sm-12 col-md-12 col-lg-6 col-xl-5">
                     <img src={d.theyimage?.localFile?.childImageSharp?.resize?.src}/>
                       

                     </div>
                     <div class="wva_right  col-sm-12 col-md-12 col-lg-6 col-xl-6">
                       <h3>{d.theytitle}</h3>
                       <div dangerouslySetInnerHTML={{ __html: d.theycontent }} />
                       <Link className="btn btn-primary" to={d.theylink.link}>{d.theylink.title}</Link>
                     </div>
...
export const query = graphql`
  {
    wpPage(title: {eq: "Company Liquidation Sydney"}) {
...
export default CompanyLiquidationSydney
