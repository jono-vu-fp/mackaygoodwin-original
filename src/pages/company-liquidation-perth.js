...
const CompanyLiquidationPerth = ({ data }) => {
  ...
  const breadCrumbs = [
    { link: "/", title: "Home" }, 
    { title: "Company Liquidation Perth" },
  ];
      ...
      <div class="rtsec2">
            ...
            <ul>
              {data.wpPage.iconWithTextSection.iconwithtextrowon.map(
                (d, key) => {
                  return (
                    <li>
                    <img src={d.iconon?.localFile?.publicURL} alt="" /> 
       ...
       <div className="wbl_section">
              <div className="container">
                ...
                <a href="javascript:void(0);" onClick={()=>setShowVid(true)}><img alt="" src={data.wpPage.expertsInBlock.expmomentsThumbnail?.localFile?.childImageSharp?.resize?.src} /></a>
      ...
      <div className="wcmg_section margin_bottom">
        ...
        <div className="container">
          ...
          <div className="wva_right">
           <img alt="" src={data.wpPage.whatIsLiquidation.whatThumbnail?.localFile?.childImageSharp?.resize?.src} />
          </div>
       ...
       <div className="wva_section fd_section dca_section dpn_part margin_bottom wil_section">
        <div className="container">
          <div className="wva_left">
            <img alt="" src={data.wpPage.whatIsLiquidation.whatThumbnail?.localFile?.childImageSharp?.resize?.src} />
        </div>
       ...
       <div className="wbl_section">
              <div className="container">
                <div className="wbl_left">
                   <img alt="" class="img-fluid" src={data.wpPage.leftImageAndRightContent
...
export const query = graphql`
  {
    wpPage(title: {eq: "Company Liquidation Perth"}) {
...
export default CompanyLiquidationPerth
