    ...
    <nav className="navbar navbar-light bg-light position-fixed col-12 desktopNav mainnav megamenu">
      <div className="container">
        ...
        {newTopbar?<ul className="top-belt d-flex ms-auto no_line"><li className="nav-item">
              <a className="nav-link" aria-current="page" href="#get-in-touch">{typeof window !== "undefined" && window.screen.width > 979 ? "Book your free consultation today" : "Call 1300 750 599"} <i className="fa fa-chevron-right"></i></a>
            </li></ul>:<ul className="top-belt d-flex ms-auto">
          {/*<li className="nav-item">
            <a className="nav-link" aria-current="page" href="tel:1300 750 599">{typeof window !== "undefined" && window.screen.width > 979 ? "Speak to our experts 1300 750 599" : "Call 1300 750 599"} <i className="fa fa-chevron-right"></i></a>
          </li>*/}
          <li className="nav-item">
            ...
            <div id="menu-cont-2">
              ...
              <ul className="menu-ul submain">
                ...
                <li className="nav-item no_margin"><Link to="/corporate-advisory/">Corporate Advisory</Link></li>
                 <li className="nav-item no_margin">
                    <Link className="dropdown-item" to="/cyber-security/">Cyber Security</Link>
                    </li>
                     <li>
                    <Link className="dropdown-item" to="/research-and-development/">R&D Tax Advisory</Link>
