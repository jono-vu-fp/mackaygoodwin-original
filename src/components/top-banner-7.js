...
const topBanner = (props) => {
	...
	return (
		<section id="banner-section" className="liq_banner referral-ban">
			<div className="container position-relative">
				<div className="row">
				<div className={typeof props.equalWidth !== "undefined" && props.equalWidth ? "col-sm-12 col-md-12 col-lg-7 col-xl-7" : "col-sm-12 col-md-12 col-lg-7 col-xl-7 pad-left"}>
						<div className="banner-image">
							<img src={props.bannerImg?.localFile?.childImageSharp?.resize?.src} className="img-fluid" alt={props.bannerImg?.altText} />
						</div>
					</div>

					<div className={typeof props.equalWidth !== "undefined" && props.equalWidth ? "col-sm-12 col-md-12 col-lg-5 col-xl-5" : "col-sm-12 col-md-12 col-lg-5 col-xl-5"}>
