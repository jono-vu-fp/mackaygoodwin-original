...
const AccordianSlideDpn = (props) => {
  ...
  const setCls = function(this_ele){
    ...
    if($(this_ele).closest('.accordion-item').hasClass('active')){
      ...
      console.log(333);
      $('#accordionExampleDpn .accordion-item').removeClass('active');
  ...
  return <div className="accordion-item" key={props.keyloc}>
    <h3 className="accordion-header" id={"heading" + props.keyloc}>
      <button
        ...
        data-bs-target={"#collapsedpn" + props.keyloc}
        aria-expanded="false"
    ...
    <div id={"collapsedpn" + props.keyloc} className="accordion-collapse collapse hide" aria-labelledby={"heading" + props.keyloc} data-bs-parent="#accordionExampleDpn">
...
export default AccordianSlideDpn
