...
const AccordianSlide = (props) => {
  ...
  return <div className="accordion-item active" key={props.keyloc}>
    ...
    <div id={"collapse" + props.keyloc} className="accordion-collapse collapse show" aria-labelledby={"heading" + props.keyloc} data-bs-parent="#accordionExample">
