	...
	return (
		<section id="banner-section" className="liq_banner">
			<div className="container position-relative">
				<div className="row">
				<div className={typeof props.equalWidth !== "undefined" && props.equalWidth ? "col-sm-12 col-md-12 col-lg-7 col-xl-7" : "col-sm-12 col-md-12 col-lg-5 col-xl-4"}>
						<div className="banner-image">
							<img src={props.bannerImg?.mediaItemUrl} className="img-fluid" alt={props.bannerImg?.altText} />
						</div>
					</div>

					<div className={typeof props.equalWidth !== "undefined" && props.equalWidth ? "col-sm-12 col-md-12 col-lg-5 col-xl-6" : "col-sm-12 col-md-12 col-lg-6 col-xl-6"}>
