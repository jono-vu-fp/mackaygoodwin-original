...
const PeopleList = (props) => {
  ...
  useEffect(() => {
    ...
    //console.log(d, s, ds)
    setSuffledData(ds);
    if(shuffleData==undefined && window.location.href!='https://mackaygoodwin.com.au/'){window.location.href='/404';}
  }, []);
