...
import MackeyWhite from "../../images/mg-logo.svg";
          ...
          {props.data?.map((d, key) => {
            return <div className="col-lg-4 col-md-12  mt-4" key={key}>
               <div className={d.altimg?"staff-listbg listbg":"listbg"}>
                {d.img?.localFile?<img className="img-fluid" style={{ width: "100%" }} src={d.img?.localFile?.childImageSharp?.resize?.src} alt={d.img?.altTxt} />:<img className="img-fluid" style={{ width: "100%" }} src={MackeyWhite} alt={d.img?.altTxt} />}
