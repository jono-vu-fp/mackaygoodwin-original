...
const News = (props) => {
  ...
  return <section className="news-articles" id="news-articles">
    <div className="container">
      <div className="row">
        <h2 className="my-5">{props.title}</h2>
        <div className="col-lg-7 col-md-7 p-0">
          <img className="img-fluid" style={{ width: "100%" }} src={props.data[0].featuredImage?.node?.localFile?.publicURL} alt={props.data[0].featuredImage?.node?.altText} />
        </div>
