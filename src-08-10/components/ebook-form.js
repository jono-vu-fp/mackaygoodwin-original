...
import { formEbookContext, formHealthContext } from './context';
...
const HealthForm = (props) => {
  ...
  const { fromEbookDetails, setFormEbookDetails } = React.useContext(formEbookContext);

  return (
    <div className={fromEbookDetails === 1 ? "modal fade show peopleModal" : "modal fade "} id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div className="modal-dialog modal-dialog-centered modal-xl">
        <div className="modal-content">
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => { setFormEbookDetails(0) }}></button>
