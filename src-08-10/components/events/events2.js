...
const Events = (props) => {
  ...
  return (
  <section className="events mg_events" id="events2">
    <div className="container">
      <h2 className="my-5 event_pro_title">{props.title}</h2>
      <div className="row">
        ...
        <h2> Past Events </h2>
        <div className="events_section_1"></div>
        {past.map((d, key) => {
          return <EventsList key={key} data={d} setVideoUrl={props.setVideoUrl} />
        })}
      </div>
